            ...
            case 'stsd':
                {
                    ...
                    for (let i = 0; i < entries; i++) {
                        ...
                        if (track.info.type === 'video') {
                            ...
                            readU16Be(slice); // Data reference index
...
class IsobmffSubtitleTrackBacking extends IsobmffTrackBacking {
    ...
    async *getCues(startTimestamp = 0) {
        // Use the existing packet reading infrastructure
        let packet = startTimestamp > 0 ? await this.getPacket(startTimestamp, {}) : await this.getFirstPacket({});
        while (packet) {
