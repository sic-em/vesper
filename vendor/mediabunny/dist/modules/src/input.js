...
import { InputAudioTrack, InputSubtitleTrack, InputVideoTrack, mergeInputTrackQueries, queryInputTracks, toValidatedInputTrackQuery, prefer, desc, } from './input-track.js';
...
export class Input extends EventEmitter {
    ...
    _wrapBackingAsTrack(backing) {
        ...
        const track = type === 'video'
            ? new InputVideoTrack(this, backing)
            : type === 'audio'
                ? new InputAudioTrack(this, backing)
                : new InputSubtitleTrack(this, backing);
